...
import { PLACEHOLDER_IMAGES } from '../../assets/images';

const PH = PLACEHOLDER_IMAGES.product;
...
export const menuData: Record<string, MenuItem[]> = {
  ...
  '1': [
    { id:'m1-1', restaurantId:'1', name:'Lechona Tolimense Completa',
      ...
      price:28000, image:getMenuImage('m1-1', PH), category:'principales', isPopular:true, rating:4.9, available:true },
    { id:'m1-2', restaurantId:'1', name:'Media Lechona con Arepa',
      ...
      price:18000, image:getMenuImage('m1-2', PH), category:'principales', rating:4.8, available:true },
    { id:'m1-3', restaurantId:'1', name:'Tamal Tolimense',
      ...
      price:12000, image:getMenuImage('m1-3', PH), category:'entradas', isPopular:true, rating:4.7, available:true },
    { id:'m1-4', restaurantId:'1', name:'Avena Tolimense Caliente',
      ...
      price:5000, image:getMenuImage('m1-4', PH), category:'bebidas', rating:4.6, available:true },
    { id:'m1-5', restaurantId:'1', name:'Achiras del Tolima',
      ...
      price:8000, image:getMenuImage('m1-5', PH), category:'postres', rating:4.5, available:true },
    { id:'m1-6', restaurantId:'1', name:'Combo Lechona Familiar',
      ...
      price:75000, image:getMenuImage('m1-6', PH), category:'combos', isPopular:true, discount:15, rating:4.9, available:true },
    { id:'m1-7', restaurantId:'1', name:'Sancocho de Costilla Ibagueño',
      ...
      price:20000, image:getMenuImage('m1-7', PH), category:'recomendados', isNew:true, rating:4.8, available:true },
  ],
  ...
  '2': [
    { id:'m2-1', restaurantId:'2', name:'Tamal Tolimense Clásico',
      ...
      price:12000, image:getMenuImage('m2-1', PH), category:'principales', isPopular:true, rating:4.9, available:true },
    { id:'m2-2', restaurantId:'2', name:'Tamal de Pipián Tolimense',
      ...
      price:14000, image:getMenuImage('m2-2', PH), category:'principales', isNew:true, rating:4.7, available:true },
    { id:'m2-3', restaurantId:'2', name:'Arepa de Chócolo con Queso',
      ...
      price:6000, image:getMenuImage('m2-3', PH), category:'entradas', rating:4.6, available:true },
    { id:'m2-4', restaurantId:'2', name:'Avena Fría Tolimense',
      ...
      price:5000, image:getMenuImage('m2-4', PH), category:'bebidas', rating:4.8, available:true },
    { id:'m2-5', restaurantId:'2', name:'Combo Desayuno Ibagueño',
      ...
      price:28000, image:getMenuImage('m2-5', PH), category:'combos', isPopular:true, discount:20, rating:4.9, available:true },
    { id:'m2-6', restaurantId:'2', name:'Docena de Tamales para Llevar',
      ...
      price:120000, image:getMenuImage('m2-6', PH), category:'recomendados', discount:10, rating:4.8, available:true },
  ],
  ...
  '3': [
    { id:'m3-1', restaurantId:'3', name:'Sancocho de Gallina Criolla',
      ...
      price:22000, image:getMenuImage('m3-1', PH), category:'principales', isPopular:true, rating:4.9, available:true },
    { id:'m3-2', restaurantId:'3', name:'Mondongo Ibagueño',
      ...
      price:20000, image:getMenuImage('m3-2', PH), category:'principales', rating:4.7, available:true },
    { id:'m3-3', restaurantId:'3', name:'Almuerzo Casero Completo',
      ...
      price:18000, image:getMenuImage('m3-3', PH), category:'combos', isPopular:true, rating:4.8, available:true },
    { id:'m3-4', restaurantId:'3', name:'Jugo de Cholupa Natural',
      ...
      price:5000, image:getMenuImage('m3-4', PH), category:'bebidas', rating:4.7, available:true },
    { id:'m3-5', restaurantId:'3', name:'Natilla Tolimense',
      ...
      price:7000, image:getMenuImage('m3-5', PH), category:'postres', rating:4.6, available:true },
  ],
  ...
  '5': [
    { id:'m5-1', restaurantId:'5', name:'Chorizo Tolimense a la Parrilla',
      ...
      price:18000, image:getMenuImage('m5-1', PH), category:'principales', isPopular:true, rating:4.8, available:true },
    { id:'m5-2', restaurantId:'5', name:'Costillas BBQ Tolimenses',
      ...
      price:32000, image:getMenuImage('m5-2', PH), category:'principales', isPopular:true, rating:4.9, available:true },
    { id:'m5-3', restaurantId:'5', name:'Morcilla y Longaniza',
      ...
      price:22000, image:getMenuImage('m5-3', PH), category:'entradas', isPopular:true, rating:4.7, available:true },
    { id:'m5-4', restaurantId:'5', name:'Papa Criolla Asada',
      ...
      price:10000, image:getMenuImage('m5-4', PH), category:'entradas', rating:4.5, available:true },
    { id:'m5-5', restaurantId:'5', name:'Limonada de Panela',
      ...
      price:6000, image:getMenuImage('m5-5', PH), category:'bebidas', rating:4.6, available:true },
    { id:'m5-6', restaurantId:'5', name:'Parrillada Familiar La Pola',
      ...
      price:75000, image:getMenuImage('m5-6', PH), category:'combos', isPopular:true, discount:15, rating:4.9, available:true },
    { id:'m5-7', restaurantId:'5', name:'Postre de Guanábana',
      ...
      price:10000, image:getMenuImage('m5-7', PH), category:'postres', rating:4.6, available:true },
  ],
  ...
  '9': [
    { id:'m9-1', restaurantId:'9', name:'Bowl Proteico Tolimense',
      ...
      price:28000, image:getMenuImage('m9-1', PH), category:'principales', isPopular:true, rating:4.9, available:true },
    { id:'m9-2', restaurantId:'9', name:'Ensalada de Frutas Tropicales',
      ...
      price:18000, image:getMenuImage('m9-2', PH), category:'principales', rating:4.7, available:true },
    { id:'m9-3', restaurantId:'9', name:'Jugo Verde Detox Ambalá',
      ...
      price:14000, image:getMenuImage('m9-3', PH), category:'bebidas', isPopular:true, rating:4.8, available:true },
    { id:'m9-4', restaurantId:'9', name:'Wrap Vegano de la Región',
      ...
      price:20000, image:getMenuImage('m9-4', PH), category:'entradas', isNew:true, rating:4.6, available:true },
    { id:'m9-5', restaurantId:'9', name:'Combo Fit Ibagueño',
      description:'Bowl proteico + jugo verde detox + fruta de temporada tolimense.',
      price:38000, image:getMenuImage('m9-5', PH), category:'combos', discount:10, rating:4.9, available:true },
    { id:'m9-6', restaurantId:'9', name:'Granola con Frutas del Tolima',
      ...
      price:16000, image:getMenuImage('m9-6', PH), category:'postres', rating:4.7, available:true },
  ],
  ...
  '13': [
    { id:'m13-1', restaurantId:'13', name:'Café Tolimense Espresso',
      ...
      price:6000, image:getMenuImage('m13-1', PH), category:'bebidas', isPopular:true, rating:4.8, available:true },
    { id:'m13-2', restaurantId:'13', name:'Café con Leche Ibagueño',
      ...
      price:8000, image:getMenuImage('m13-2', PH), category:'bebidas', isPopular:true, rating:4.9, available:true },
    { id:'m13-3', restaurantId:'13', name:'Almojábana con Queso',
      ...
      price:7000, image:getMenuImage('m13-3', PH), category:'entradas', rating:4.7, available:true },
    { id:'m13-4', restaurantId:'13', name:'Torta de Novia Tolimense',
      ...
      price:12000, image:getMenuImage('m13-4', PH), category:'postres', isPopular:true, rating:4.9, available:true },
    { id:'m13-5', restaurantId:'13', name:'Combo Desayuno Musical',
      ...
      price:18000, image:getMenuImage('m13-5', PH), category:'combos', discount:10, rating:4.8, available:true },
    { id:'m13-6', restaurantId:'13', name:'Pandeyuca Artesanal',
      ...
      price:6000, image:getMenuImage('m13-6', PH), category:'recomendados', isNew:true, rating:4.7, available:true },
  ],
  ...
  '17': [
    { id:'m17-1', restaurantId:'17', name:'Lechona Deconstruida',
      ...
      price:55000, image:getMenuImage('m17-1', PH), category:'principales', isPopular:true, rating:4.9, available:true },
    { id:'m17-2', restaurantId:'17', name:'Tamal Gourmet de Autor',
      ...
      price:48000, image:getMenuImage('m17-2', PH), category:'principales', isPopular:true, rating:4.8, available:true },
    { id:'m17-3', restaurantId:'17', name:'Ceviche de Cachama Tolimense',
      ...
      price:38000, image:getMenuImage('m17-3', PH), category:'entradas', rating:4.7, available:true },
    { id:'m17-4', restaurantId:'17', name:'Coctel de Cholupa y Ron',
      ...
      price:22000, image:getMenuImage('m17-4', PH), category:'bebidas', rating:4.8, available:true },
    { id:'m17-5', restaurantId:'17', name:'Postre de Guanábana y Achira',
      ...
      price:20000, image:getMenuImage('m17-5', PH), category:'postres', isNew:true, rating:4.9, available:true },
    { id:'m17-6', restaurantId:'17', name:'Menú Degustación Tolimense',
      ...
      price:120000, image:getMenuImage('m17-6', PH), category:'combos', discount:10, rating:4.9, available:true },
  ],
};
