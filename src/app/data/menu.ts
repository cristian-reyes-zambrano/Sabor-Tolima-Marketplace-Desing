/**
 * Datos de menú por restaurante - Sabor Tolima Marketplace
 *
 * CÓMO CAMBIAR UNA FOTO DE PLATO:
 * 1. Pon tu JPG en:  src/assets/images/menu/restaurante-X/nombre.jpg
 * 2. Abre:           src/assets/images/menu/index.ts
 * 3. Descomenta la línea del import y la línea del MENU_IMAGES
 * 4. Listo — la foto local reemplaza automáticamente la URL de Unsplash
 */
  ...
  '1': [
    {
      ...
      price: 28000,
      image: getMenuImage('m1-1', 'https://images.pexels.com/photos/2338407/pexels-photo-2338407.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 18000,
      image: getMenuImage('m1-2', 'https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 12000,
      image: getMenuImage('m1-3', 'https://images.pexels.com/photos/6605208/pexels-photo-6605208.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 5000,
      image: getMenuImage('m1-4', 'https://images.pexels.com/photos/4397899/pexels-photo-4397899.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 8000,
      image: getMenuImage('m1-5', 'https://images.pexels.com/photos/1775043/pexels-photo-1775043.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 75000,
      image: getMenuImage('m1-6', 'https://images.pexels.com/photos/5560763/pexels-photo-5560763.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 20000,
      image: getMenuImage('m1-7', 'https://images.pexels.com/photos/1731535/pexels-photo-1731535.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
  ...
  '2': [
    {
      ...
      price: 12000,
      image: getMenuImage('m2-1', 'https://images.pexels.com/photos/6605208/pexels-photo-6605208.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
      category: 'principales', isPopular: true, rating: 4.9, available: true,
    },
    {
      ...
      price: 14000,
      image: getMenuImage('m2-2', 'https://images.pexels.com/photos/6605207/pexels-photo-6605207.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 6000,
      image: getMenuImage('m2-3', 'https://images.pexels.com/photos/4958641/pexels-photo-4958641.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 5000,
      image: getMenuImage('m2-4', 'https://images.pexels.com/photos/4397899/pexels-photo-4397899.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 28000,
      image: getMenuImage('m2-5', 'https://images.pexels.com/photos/5560763/pexels-photo-5560763.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 120000,
      image: getMenuImage('m2-6', 'https://images.pexels.com/photos/6605209/pexels-photo-6605209.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
  ...
  '5': [
    {
      ...
      price: 22000,
      image: getMenuImage('m5-1', 'https://images.pexels.com/photos/1639557/pexels-photo-1639557.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 32000,
      image: getMenuImage('m5-2', 'https://images.pexels.com/photos/3219483/pexels-photo-3219483.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 28000,
      image: getMenuImage('m5-3', 'https://images.pexels.com/photos/2338407/pexels-photo-2338407.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 14000,
      image: getMenuImage('m5-4', 'https://images.pexels.com/photos/1583884/pexels-photo-1583884.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 8000,
      image: getMenuImage('m5-5', 'https://images.pexels.com/photos/2109099/pexels-photo-2109099.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
      category: 'bebidas', rating: 4.6, available: true,
    },
    {
      ...
      price: 45000,
      image: getMenuImage('m5-6', 'https://images.pexels.com/photos/1600727/pexels-photo-1600727.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 12000,
      image: getMenuImage('m5-7', 'https://images.pexels.com/photos/45202/brownie-dessert-cake-sweet-45202.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'),
  ...
  '9': [
    {
      ...
      price: 28000,
      image: getMenuImage('m9-1', 'https://images.unsplash.com/photo-1546793665-c74683f339c1?w=400&h=300&fit=crop'),
      category: 'principales', isPopular: true, rating: 4.9, available: true,
    },
    {
      ...
      price: 24000,
      image: getMenuImage('m9-2', 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 14000,
      image: getMenuImage('m9-3', 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 20000,
      image: getMenuImage('m9-4', 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 38000,
      image: getMenuImage('m9-5', 'https://images.unsplash.com/photo-1546793665-c74683f339c1?w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 16000,
      image: getMenuImage('m9-6', 'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=400&h=300&fit=crop'),
      category: 'postres', rating: 4.7, available: true,
    },
  ],
  ...
  '13': [
    {
      ...
      price: 6000,
      image: getMenuImage('m13-1', 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=400&h=300&fit=crop'),
      category: 'bebidas', isPopular: true, rating: 4.8, available: true,
    },
    {
      ...
      price: 9000,
      image: getMenuImage('m13-2', 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 8000,
      image: getMenuImage('m13-3', 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400&h=300&fit=crop'),
      category: 'entradas', rating: 4.6, available: true,
    },
    {
      ...
      price: 14000,
      image: getMenuImage('m13-4', 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 22000,
      image: getMenuImage('m13-5', 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 12000,
      image: getMenuImage('m13-6', 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400&h=300&fit=crop'),
  ...
  '17': [
    {
      ...
      price: 38000,
      image: getMenuImage('m17-1', 'https://images.unsplash.com/photo-1579871494447-9811cf80d66c?w=400&h=300&fit=crop'),
      category: 'principales', isPopular: true, rating: 4.9, available: true,
    },
    {
      ...
      price: 45000,
      image: getMenuImage('m17-2', 'https://images.unsplash.com/photo-1579871494447-9811cf80d66c?w=400&h=300&fit=crop'),
      category: 'principales', isPopular: true, rating: 4.8, available: true,
    },
    {
      ...
      price: 12000,
      image: getMenuImage('m17-3', 'https://images.unsplash.com/photo-1546793665-c74683f339c1?w=400&h=300&fit=crop'),
      category: 'entradas', rating: 4.6, available: true,
    },
    {
      ...
      price: 18000,
      image: getMenuImage('m17-4', 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 16000,
      image: getMenuImage('m17-5', 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 85000,
      image: getMenuImage('m17-6', 'https://images.unsplash.com/photo-1579871494447-9811cf80d66c?w=400&h=300&fit=crop'),
      category: 'combos', discount: 10, rating: 4.9, available: true,
    },
  ],
};
  ...
  return [
    {
      ...
      price: 22000,
      image: getMenuImage(`${restaurantId}-d1`, 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 14000,
      image: getMenuImage(`${restaurantId}-d2`, 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 6000,
      image: getMenuImage(`${restaurantId}-d3`, 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 10000,
      image: getMenuImage(`${restaurantId}-d4`, 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=300&fit=crop'),
    ...
    },
    {
      ...
      price: 35000,
      image: getMenuImage(`${restaurantId}-d5`, 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400&h=300&fit=crop'),
