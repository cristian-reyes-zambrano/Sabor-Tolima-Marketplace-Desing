        ...
        <div className="p-5">
          ...
          {step === 'login' && (
            <div className="space-y-4">
              ...
              <div className="text-center">
                <button
                  type="button"
                  onClick={() => { resetForm(); setStep('role'); }}
          ...
          {step === 'register' && (
            <form onSubmit={handleRegister} className="space-y-3">
              ...
              />
              <FormField
                id="reg-confirm" label="Confirmar contraseña"
              ...
              {selectedRole === 'seller' && (
                <div className="flex items-start gap-2 p-3 bg-amber-50 rounded-xl text-xs text-amber-800">
                  ...
                  <span>
                    Después del registro completarás el perfil de tu restaurante
                    y subirás los documentos requeridos.
                  </span>
                </div>
              )}
...
function RoleCard({
  ...
  return (
    ...
    >
      ...
      {selected && (
        <CheckCircle2 className={`w-4 h-4 ${color === 'primary' ? 'text-primary' : 'text-accent'}`} />
      )}
    </button>
  );
}
